...
public class SFXBank {
	...
	public Sound getSound(String key) {
		// Returnerar ett ljud med vald nyckel. Nyckeln görs om till lower case
		// för att undvika nullPointer
	...
	/*
	 * onödig funktion, kan dock komma till pass om man t.ex. vill alternera
	 * mellan två olika hoppljud. metoden returnerar ett slumpmässigt valt ljud
	 */
